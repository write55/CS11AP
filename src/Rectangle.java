 ...
 * Also gives the dimensions entered and the area of the printed rectangle
 * It also error-traps to make sure dimensions are within desired limits and allows the user to choose when the program ends
 */
...
public class Rectangle {
	...
	public String toString() {
		...
		return "\nYour Rectangle is " + w + " stars across and " + h + " stars down, with an area of " + w * h + "\n";
	}
