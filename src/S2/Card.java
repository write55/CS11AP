 ...
 * S2.Card.java
 *
 * <code>S2.Card</code> represents a playing card.
 */
public class Card {
    ...
    /**
     * Creates a new <code>S2.Card</code> instance.
     *
     ...
     * @param cardPointValue an <code>int</code> value containing the point value of the
     *                       card
     */
    ...
    /**
     * Accesses this <code>S2.Card's</code> suit.
     *
     * @return this <code>S2.Card's</code> suit.
     */
    public String suit() {
        return suit;
    }
    ...
    /**
     * Accesses this <code>S2.Card's</code> rank.
     *
     * @return this <code>S2.Card's</code> rank.
     */
    public String rank() {
        return rank;
    }
    ...
    /**
     * Accesses this <code>S2.Card's</code> point value.
     *
     * @return this <code>S2.Card's</code> point value.
     */
     ...
     * way of printing the contents of a <code>S2.Deck</code> in an easily readable
